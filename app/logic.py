...
def calculate_price(args: dict) -> dict:
    ...
    if shower_type == "П-образная":
        ...
        sku_qty = {
            ...
            "AA11": (
                6 if mount_type == "На коннекторах" and door_count == "Одна от стекла 180"
    ...
    if shower_type in ["Прямая распашная", "Угловая распашная", "П-образная"]:
        binding_prices = {
            "Круглая труба": {
                "Хром": 3000,
                "Черная": 5000,
    ...
    elif shower_type in ["Прямая раздвижная", "Угловая раздвижная"]:
        binding_prices = {
            "Круглая труба": {
                "Хром": 0,
                "Черная": 0,
        ...
        binding_prices = {
            "Круглая труба": {"Хром": 0, "Черная": 0, "Бронза": 0, "Золото": 0},
            "Квадратная труба": {"Хром": 0, "Черная": 0, "Бронза": 0, "Золото": 0},
            "G-профиль": {
                "Хром": 1000,     # HF-3
                "Черная": 1500,   # HF-3b
                "Бронза": 0,      # HF-3br = x
